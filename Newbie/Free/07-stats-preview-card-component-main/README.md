...
- **Carga Dinamica del Contenido:** Incluye tres archivos .JSON para la carga de los datos de la empresa, como las empresas ayudadas, las plantillas disponibles y su consultas. La carga de los idiomas
...
- **JSON:** Almacenamiento de los datos de la empresa y los idiomas.

- **_Google Fonts:_** Fuente _Lexend Deca_ e _Inter_ para un diseño moderno.
...
- Ver en Vivo: [Aqui](https://stats-preview-componente.netlify.app/)
...
2. **Navega al directorio del proyecto**:
   ...
   ```bash
   cd Frontend-Challenges/Newbie/Free/07-stats-preview-card-component-main
...
2. Muestra la informacion de las estadisticas de la empresa.
