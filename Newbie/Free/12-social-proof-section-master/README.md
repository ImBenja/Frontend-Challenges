...
- **_Google Fonts:_** Fuente _League Spartan_ para un diseño moderno.
...
- Ver en Vivo: [Aqui](https://master-section-social.netlify.app/)
...
2. **Navega al directorio del proyecto**:
   ...
   ```bash
   cd Frontend-Challenges/Newbie/Free/12-social-proof-section-master
