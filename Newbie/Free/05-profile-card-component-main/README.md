...
> Este proyecto es un componente social que muestra información sobre seguidores, likes y fotos de la persona y links para acceder a sus redes, un boton para cada link de manera interactiva y visualmente atractiva. Está diseñado para ser completamente responsive, con diseños adaptados tanto para móviles como para escritorio. Además, utiliza un diseño CSS flexbox moderno y eficiente para su visualización.
...
- **Desglose por categorías:** Muestra la tarjeta social con la foto de perfil de la persona y su informacion en redes sociales.
...
- **_Google Fonts:_** Fuente _Kumbh Sans_ para un diseño moderno.
...
- Ver en Vivo: [Aqui](https://profile-componentr.netlify.app/)
...
2. **Navega al directorio del proyecto**:
   ...
   ```bash
   cd Frontend-Challenges/Newbie/Free/05-profile-card-component-main
...
2. Muestra la informacion de las redes y la foto de perfil en una tarjeta.
...
Puedes ver una demostración en vivo del proyecto **<a href="https://profile-componentr.netlify.app/">Aqui</a>**
