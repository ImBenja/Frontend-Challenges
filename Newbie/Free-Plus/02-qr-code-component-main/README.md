# Results QR code component

![Design preview for the QR code component coding challenge](./design/results/Desktop-Result.png)

# 📝 Descripción

> Este proyecto es un qr que te permite mejorar tus habilidades de front-end una vista previa y contiene información sobre el aprendizaje del alumno, el contenido del alumno , su creador y una descripcion, de manera interactiva y visualmente atractiva. Está diseñado para ser completamente responsive, con diseños adaptados tanto para móviles como para escritorio. Además, utiliza un diseño CSS flexbox moderno y eficiente para su visualización.
...
- **JSON:** Almacenamiento de los Idiomas.
...
2. **Navega al directorio del proyecto**:
   ...
   ```bash
   cd Proyects-Mentor/Newbie/Free+/02-qr-code-component-main
...
- Ver este Desafio [**Aqui**](https://component-qr-preview.netlify.app/)

## 💻 Uso

El componente funciona de la siguiente manera:

1. Muestra la informacion del QR en una tarjeta.

2. Se adapta automáticamente a diferentes tamaños de pantalla.

3. Presiona el botón de cambio de idioma para alternar entre español e inglés. Los textos se cargan dinámicamente desde los archivos _es.json_ y _en.json_.
